...
function registTagGrp() {
    if (confirm("<spring:message code="common.regist.msg" />")) {
        if (!document.resultVO.tagGrpId.value) {
            alert("태그 그룹 아이디를 입력하여 주시기 바랍니다.");
            document.resultVO.tagGrpId.focus();
            return false;
        }
        if (!document.resultVO.tagGrpNm.value) {
            ...
            $ifx.promise()
                .then(function (ok, fail) {
                    $ifx.ajax('<c:url value="/cms/info/interaction/tag/InsertTagGroup.do"/>', {
                        method: 'GET',
                        data: data,
...
<div class="sub subView">
    ...
    <form:form commandName="resultVO" name="resultVO" action="${pageContext.request.contextPath}/cms/info/interaction/tag/InsertTagGroup.do" method="post" onSubmit="fn_regist_page(document.forms[0]); return false;">
        <div class="rows white-box">
            ...
            <table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
                ...
                <tr>
                    ...
                    <td class="left">
                        <form:input path="tagGrpId" size="50" maxlength="100" name="tagGrpId"/>
        ...
        <div class="btn-set right">
            <button type="button" class="button" onclick="registTagGrp()">등록</button>
        </div>

...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <form:input path="upperMenuId" maxlength="10" title="<spring:message code='comSymMnuMpm.menuRegist.upperMenuId'/>" readonly class="readOnlyClass" cssStyle="width:50px" /><!-- 상위메뉴No -->
		...
		<tr>
			...
			<td class="left" colspan="3">
			    <form:input path="progrmFileNm" maxlength="60" onkeypress="press();" title="파일명" readonly class="readOnlyClass" cssStyle="width:350px" /><!-- 파일명 -->

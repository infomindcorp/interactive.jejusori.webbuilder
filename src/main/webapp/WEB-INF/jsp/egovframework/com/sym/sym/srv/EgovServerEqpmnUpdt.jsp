		...
		<tr>
			...
			<td class="left">
			    <label for="regstYmd">
		            ...
		            <input type="text" name="regstYmd" id="regstYmd" value="<c:out value="${serverEqpmn.regstYmd}"/>" maxlength="10" readonly title="<spring:message code="comSymSymSrv.serverEqpmnUpdt.regstYmd"/>" style="width:70px" /><!-- 등록일자 -->

...
<div class="wTableFrm">
	...
	<table class="wTable mb20">
		...
		<tr>
			...
			<td class="left">
			    <textarea name="changerqesterCn" class="textarea"  cols="75" rows="5" readOnly style="width:450px;border:0;background-color:transparent;filter: chroma(color=ffffff);" title="<spring:message code="comSymPrm.programChgHstDetail.changerqesterCn"/>"><c:out value="${resultVO.changerqesterCn}"/></textarea>
			</td>
		</tr>
	</table>
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <textarea name="rqesterProcessCn" class="textarea"  cols="75" rows="5" readOnly style="width:450px;border:0;background-color:transparent;filter: chroma(color=ffffff);" title="<spring:message code="comSymPrm.programChgHstDetail.rqesterProcessCn"/>"><c:out value="${resultVO.rqesterProcessCn}"/></textarea>
			</td>
		</tr>
	</table>

...
<div class="wTableFrm">
	...
	<table class="wTable mb20">
		...
		<tr>
			...
			<td class="left">
				...
				<form:input path="processDe" cssClass="txaIpt" title="${vprocessDe}" readonly cssStyle="width:70px"/>
		...
		<tr>
			...
			<td class="left">
			    <form:input path="opetrId" cssClass="txaIpt" maxlength="30" title="${vopetrId}" readonly />
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <form:textarea path="changerqesterCn" rows="5" cols="75" readonly cssClass="txaClass" title="변경요청내용"/>

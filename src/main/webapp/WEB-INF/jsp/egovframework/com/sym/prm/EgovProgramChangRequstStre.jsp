...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <form:input path="rqesterNo" size="50"  maxlength="50"  title="${vrqesterNo}" readonly /><!-- 요청번호 -->
		...
		<tr>
			...
			<td class="left">
			    <input id="progrmFileNm" name="progrmFileNm" maxlength="50"  title="<spring:message code="comSymPrm.programChangRequstStre.progrmFileNm"/>" readonly /><!-- 프로그램파일명 -->
		...
		<tr>
			...
			<td class="left">
			    <form:input path="rqesterPersonId" size="20"  maxlength="20"  title="${vrqesterPersonId}" readonly /><!-- 요청자 -->
		...
		<tr>
			...
			<td class="left">
				...
				<input id="rqesterDe" name="rqesterDe" maxlength="50"  title="<spring:message code="comSymPrm.programChangRequstStre.rqesterDe"/>" readonly style="width:70px"/><!-- 요청일자 -->

...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <input name="progrmStrePath" type="text" size="30" value="<c:out value="${bkmkMenuManage.progrmStrePath}"/>"  maxlength="90" style="width: 235px" readonly class="readOnlyClass" title="<spring:message code="comSymMnuBmm.bkmkMenuManageRegist.enterMenuURL" />"/><!-- 메뉴URL입력 -->
			</td>
		</tr>
	</table>

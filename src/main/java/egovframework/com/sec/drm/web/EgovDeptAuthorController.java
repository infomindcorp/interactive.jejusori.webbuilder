...
public class EgovDeptAuthorController {
	 ...
	 */
	//@IncludedInfo(name="부서목록관리", order = 101)
	@RequestMapping(value="/sec/drm/EgovDeptSearchListTest.do")
	public String EgovDeptSearchListTest(@ModelAttribute("deptAuthorVO") DeptAuthorVO deptAuthorVO,
								 ModelMap model) throws Exception {
		...
		return "egovframework/com/sec/drm/EgovDeptSearch_test";
	}
}
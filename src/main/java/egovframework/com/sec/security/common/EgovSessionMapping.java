...
public class EgovSessionMapping extends EgovUsersByUsernameMapping {
    ...
    protected EgovUserDetails mapRow(ResultSet rs, int rownum) throws SQLException {
      ...
      //  System.out.println("strEnabled==>"+strEnabled);
        
        String strUserNm    = rs.getString("user_nm");
       // System.out.println("strUserNm==>"+strUserNm);
        String strUserSe    = rs.getString("user_se");
     //   System.out.println("strUserSe==>"+strUserSe);
    ...
    //    System.out.println("strUserEmail==>"+strUserEmail);
     ...
     //   System.out.println("strOrgnztId==>"+strOrgnztId);
    ...
    //    System.out.println("strUniqId==>"+strUniqId);
      ...
      //  System.out.println("strOrgnztNm==>"+strOrgnztNm);

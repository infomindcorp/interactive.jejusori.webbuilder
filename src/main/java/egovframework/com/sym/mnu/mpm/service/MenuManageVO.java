...
public class MenuManageVO{
   ...
   private   int   menuLevel;
	...
	public String getMenuTargetNo() {
		return menuTargetNo;
	}

	public void setMenuTargetNo(String menuTargetNo) {
		this.menuTargetNo = menuTargetNo;
	}
   ...
   private   String   depthFullname;
	...
	private List<MenuManageVO> childMenu = new ArrayList<>();


	public List<MenuManageVO> getChildMenu() {
		return childMenu;
	}

	public void setChildMenu(List<MenuManageVO> childMenu) {
	...
	public InfoCmsMenuAuthVO getAuthVO() {
		return authVO;
	}

	public void setAuthVO(InfoCmsMenuAuthVO authVO) {
		this.authVO = authVO;
	}
	...
	public void addChildMenu(MenuManageVO menu) {
		childMenu.add(menu);
		childMenu.sort(Comparator.comparingInt(MenuManageVO::getMenuOrdr));
	}

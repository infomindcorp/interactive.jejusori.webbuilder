...
public interface EgovMenuManageService {
	...
	List<MenuManageVO> selectMainMenuAll(MenuManageVO vo) throws Exception;


	List<MenuManageVO> binUserMenuAll(MenuManageVO vo) throws Exception;
	 ...
	 * @throws Exception
	 */
	MenuManageVO selectMenuInfo(String menuTargetNo) throws Exception;

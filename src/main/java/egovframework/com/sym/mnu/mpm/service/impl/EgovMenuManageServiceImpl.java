...
public class EgovMenuManageServiceImpl extends EgovAbstractServiceImpl implements EgovMenuManageService {
	 ...
	 * @exception Exception
	 */
	public List<MenuManageVO> selectMainMenuAll(MenuManageVO vo) throws Exception {
		return menuManageDAO.selectMainMenuAll(vo);
	}

	@Override
	public List<MenuManageVO> binUserMenuAll(MenuManageVO vo) throws Exception {
		return menuManageDAO.selectMainMenuAll(vo);
	}

	@Override
	public MenuManageVO selectMenuInfo(String menuTargetNo) throws Exception {
		return menuManageDAO.selectMenuInfo(menuTargetNo);
	}

...
import infomind.com.tags.model.WpSelectVOImpl;
...
public class EgovCcmCmmnClCodeManageController {
	...
	@IncludedInfo(name = "공통분류코드", listUrl = "/sym/ccm/ccc/SelectCcmCmmnClCodeGrid.do", order = 960, gid = 60)
	@RequestMapping(value = "/sym/ccm/ccc/SelectCcmCmmnClCodeGrid.do")
	public String SelectCcmCmmnClCodeGrid(@ModelAttribute("searchVO") CmmnClCodeVO searchVO, ModelMap model) throws Exception {



		return "egovframework/com/sym/ccm/ccc/EgovCcmCmmnClCodeGrid.sub";
	...
	/** 테스트 */
	@RequestMapping(value = "/sym/ccm/ccc/SelectCcmCmmnClCodeObject.do")
	@ResponseBody
	public ModelAndView SelectCcmCmmnClCodeObject(CmmnClCodeVO searchVO) throws Exception {


		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("jsonView");
		modelAndView.addObject("list", cmmnClCodeManageService.selectCmmnClCodeAllList(searchVO));
	...
	@RequestMapping("/sym/ccm/ccc/CodeTestList.do")
	@ResponseBody
	public List<WpSelectVOImpl> CodeTestList(@RequestParam("p1") String p1) throws Exception {


		System.out.println("CodeTestList==>");

		List<WpSelectVOImpl> myList = new ArrayList<WpSelectVOImpl>();
		myList.add(new WpSelectVOImpl("a1", "b122222"));
		myList.add(new WpSelectVOImpl("a2", "b233333"));
		myList.add(new WpSelectVOImpl("a3", "b34444"));
		myList.add(new WpSelectVOImpl("a4", "b45555"));



		System.out.println("CodeTestList==>22222-->"+myList.size());
	 ...
	 * 테스트 수정, 승인 화면
	 */
	@RequestMapping("/sym/ccm/ccc/edit.do")
	public String edit(@ModelAttribute("searchVO") CmmnClCodeVO searchVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/sym/ccm/ccc/EgovCcmCmmnClCodeView";

...
public class CmmnClCodeManageDAO extends EgovComAbstractDAO {
	   ...
	   /**
		...
		public List<CmmnClCodeVO> selectCmmnClCodeAllList(CmmnClCodeVO searchVO) throws Exception {
			return (List<CmmnClCodeVO>) list("CmmnClCodeManage.selectCmmnClCodeAllList", searchVO);
		}
